...
public class SpongeSetupUtils extends SetupUtils {
  ...
  public void updateGenerators() {
    ...
    SetupUtils.generators
        .put(PS.imp().getPluginName(), new SpongePlotGenerator(PS.get().IMP.getDefaultGenerator()));
    ...
    Collection<WorldGeneratorModifier> wgms = Sponge.getRegistry()
