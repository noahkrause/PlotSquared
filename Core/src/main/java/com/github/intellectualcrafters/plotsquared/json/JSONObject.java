 ...
 * <code>,</code>&nbsp;<small>(comma)</small> may appear just before the closing brace.</li>
 ...
 * not the reserved words <code>true</code>, <code>false</code>, or <code>null</code>.</li> </ul>
 *
 * @author JSON.org
 * @version 2014-05-03
 */
public class JSONObject {
   ...
   *
   * For example, if an object has a method named <code>"getPluginName"</code>, and if the result of
   * calling <code>object.getPluginName()</code> is <code>"Larry Fine"</code>, then the JSONObject
   * will contain <code>"name": "Larry Fine"</code>.
   *
   ...
   * will be inserted control character or an unescaped quote or backslash.
   *
