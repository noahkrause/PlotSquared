...
public abstract class PlotGenerator<T> {
  ...
  /**
   * TYPE = 2; new AugmentedPopulator(world, generator, cluster, plotWorld.TERRAIN == 2,
   * plotWorld.TERRAIN != 2); TYPE = 1 new AugmentedPopulator(world, gen_class, null,
   * plotWorld.TERRAIN == 2, plotWorld.TERRAIN != 2);
   */
