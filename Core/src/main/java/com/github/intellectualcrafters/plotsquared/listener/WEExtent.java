...
public class WEExtent extends AbstractDelegateExtent {
  ...
  public boolean setBlock(Vector location, BaseBlock block) throws WorldEditException {
    return WEManager
        .maskContains(this.mask, location.getBlockX(), location.getBlockY(), location.getBlockZ())
  ...
  public boolean setBiome(Vector2D position, BaseBiome biome) {
    return WEManager.maskContains(this.mask, position.getBlockX(), position.getBlockZ()) && super
