...
/**
 * This class writes <strong>NBT</strong>, or <strong>Named Binary Tag</strong> {@code Tag} objects
 * to an underlying {@code OutputStream}.
 *
 * <p> The NBT format was created by Markus Persson, and the specification may be found at
 * @linktourl http://www.minecraft.net/docs/NBT.txt </p>
 *
...
public final class NBTOutputStream implements Closeable {
  ...
  /**
   * Creates a new {@code NBTOutputStream}, which will write data to the specified underlying output
   * stream.
   *
