...
public abstract class ClassicPlotWorld extends SquarePlotWorld {
   ...
   *
   * <p>Set the last boolean to false if you do not check a specific config node to be set while
   * using the setup command - this may be useful if a config value can be changed at a later date,
   * and has no impact on the actual world generation</p>
   */
  @Override
  public ConfigurationNode[] getSettingNodes() {
    return new ConfigurationNode[]{
        ...
        new ConfigurationNode("wall.block_claimed", this.CLAIMED_WALL_BLOCK, "Wall block (claimed)",
            Configuration.BLOCK),
  ...
  public void loadConfiguration(ConfigurationSection config) {
    ...
    this.CLAIMED_WALL_BLOCK = Configuration.BLOCK
