...
public class HybridPlotWorld extends ClassicPlotWorld {
  ...
  /**
   * <p>This method is called when a world loads. Make sure you set all your constants here. You are
   * provided with the configuration section for that specific world.</p>
   */
  @Override
  ...
  public void setupSchematics() {
    ...
    File schematic1File =
        MainUtil.getFile(PS.get().IMP.getDirectory(),
    ...
    for (short x = 0; x < w2; x++) {
      for (short z = 0; z < l2; z++) {
        for (short y = 0; y < h2; y++) {
          ...
          if (id != 0) {
            addOverlayBlock((short) (x - shift), (short) (y + startY), (short) (z - shift), id,
                data, false, h2);
          }
        }
      }
