...
public class PlotId {
  ...
  /**
   * Get the PlotId from the HashCode<br> Note: Only accurate for small x,z values (short)
   */
  ...
  /**
   * Get the PlotId in a relative direction 0 = north<br> 1 = east<br> 2 = south<br> 3 = west<br>
   *
   * @return PlotId
   */
  ...
  /**
   * The PlotId object caches the hashcode for faster mapping/fetching/sorting<br> - Recalculation
   * is required if the x/y values change TODO maybe make x/y values private and add this to the
   * mutators
   */
