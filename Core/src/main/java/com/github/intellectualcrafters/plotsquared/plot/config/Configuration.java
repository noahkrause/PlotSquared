...
public class Configuration {
  ...
  public static final SettingValue<PlotBlock> BLOCK = new SettingValue<PlotBlock>("BLOCK") {
    @Override
    public boolean validateValue(String string) {
      StringComparison.ComparisonResult value = WorldUtil.IMP.getClosestBlock(string);
  ...
  public static final SettingValue<PlotBlock[]> BLOCKLIST = new SettingValue<PlotBlock[]>(
      "BLOCKLIST") {
    @Override
    public boolean validateValue(String string) {
      try {
    ...
    public PlotBlock[] parseString(String string) {
      ...
      for (int i = 0; i < blocks.length; i++) {
        try {
          ...
          StringComparison<PlotBlock>.ComparisonResult result = WorldUtil.IMP
              .getClosestBlock(blocks[i]);
