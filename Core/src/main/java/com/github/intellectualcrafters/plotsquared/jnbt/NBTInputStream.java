 ...
 * an object graph of subclasses of the {@code Tag} object.  The NBT format was created by Markus
 * Persson, and the specification may be found at @linktourl http://www.minecraft.net/docs/NBT.txt">
...
public final class NBTInputStream implements Closeable {
  ...
  /**
   * Creates a new {@code NBTInputStream}, which will source its data from the specified input
   * stream.
   *
