...
/**
 * Database Functions - These functions do not update the local plot objects and only make changes
 * to the DB
 */
public class DBFunc {
  ...
  /**
   * Deleting settings will 1) Delete any settings (flags and such) associated with the plot 2)
   * Prevent any local changes to the plot from saving properly to the db
   *
