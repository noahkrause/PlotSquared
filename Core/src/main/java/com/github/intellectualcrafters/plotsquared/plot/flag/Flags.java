...
public final class Flags {
  ...
  public static final IntegerListFlag ANALYSIS = (IntegerListFlag) new IntegerListFlag("analysis")
      .reserve();
          ...
          if (value.DEFAULT_FLAGS.containsKey(duplicate)) {
            ...
            try {
              if (remove instanceof Collection
                  && remove.getClass().getMethod("toString").getDeclaringClass() == Object.class) {
                value.DEFAULT_FLAGS
                    .put(flag, flag.parseValue(StringMan.join((Collection) remove, ',')));
              } else {
