...
public abstract class Flag<V> implements StringComparison.StringComparable {
  ...
  /**
   * Flag object used to store basic information for a Plot. Flags are a key/value pair. For a flag
   * to be usable by a player, you need to register it with PlotSquared.
   *
