package com.github.intellectualcrafters.plotsquared.plot.util.block;
...
public class ScopedLocalBlockQueue extends DelegateLocalBlockQueue {
  ...
  /**
   * Run a task for each x,z value corresponding to the plot at that location<br> - Plot: The plot
   * at the x,z (may be null)<br> - Location: The location in the chunk (y = 0)<br> - PlotChunk:
   * Reference to this chunk object<br>
   */
