...
public class PlotAnalysis {
  ...
  public static void calcOptimalModifiers(final Runnable whenDone, final double threshold) {
    ...
    TaskManager.runTaskAsync(new Runnable() {
      ...
      public void run() {
        ...
        settings.CALIBRATION.CHANGES =
            factorChanges == 1 ? 0 : (int) (factorChanges * 1000 / MathMan.getMean(changes));
        ...
        settings.CALIBRATION.VARIETY =
            factor_variety == 1 ? 0 : (int) (factor_variety * 1000 / MathMan.getMean(variety));
        ...
        settings.CALIBRATION.CHANGES_SD = factor_changes_sd == 1 ? 0
        ...
        settings.CALIBRATION.FACES_SD =
            factor_faces_sd == 1 ? 0 : (int) (factor_faces_sd * 1000 / MathMan.getMean(faces_sd));
        ...
        settings.CALIBRATION.DATA_SD =
            factor_data_sd == 1 ? 0 : (int) (factor_data_sd * 1000 / MathMan.getMean(data_sd));
        ...
        settings.CALIBRATION.VARIETY_SD = factor_variety_sd == 1 ? 0
  ...
  /**
   * An optimized algorithm for ranking a very specific set of inputs<br> - Input is an array of int
   * with a max size of 102400<br> - A reduced sample space allows for sorting (and ranking in this
   * case) in linear time
   */
  ...
  public List<Integer> asList() {
    return Arrays
        .asList(this.changes, this.faces, this.data, this.air, this.variety, this.changes_sd,
            this.faces_sd, this.data_sd, this.air_sd,
            this.variety_sd);
  }
