    ...
    public void onEditSession(EditSessionEvent event) {
        ...
        if (actor != null && actor.isPlayer()) {
            ...
            if (pp == null) {
                ...
                com.github.intellectualcrafters.plotsquared.plot.object.Location pLoc =
                        new com.github.intellectualcrafters.plotsquared.plot.object.Location(player.getWorld().getName(), loc.getBlockX(), loc.getBlockX(),
                                loc.getBlockZ());
