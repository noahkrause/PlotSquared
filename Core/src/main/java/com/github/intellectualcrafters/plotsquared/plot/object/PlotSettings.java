...
/**
 * Generic settings class. - Does not keep a reference to a parent class - Direct changes here will
 * not occur in the db (Use the parent plot object for that)
 */
public class PlotSettings {
  ...
  /**
   * <b>Check if the plot is merged in a direction</b><br> 0 = North<br> 1 = East<br> 2 = South<br>
   * 3 = West<br>
   *
