package com.github.intellectualcrafters.plotsquared.bukkit.generator;

import com.github.intellectualcrafters.plotsquared.bukkit.util.BukkitUtil;
import com.github.intellectualcrafters.plotsquared.bukkit.util.block.GenChunk;
...
public class BukkitPlotGenerator extends ChunkGenerator implements
  ...
  public BukkitPlotGenerator(final String world, final ChunkGenerator cg) {
    if (cg instanceof BukkitPlotGenerator) {
      throw new IllegalArgumentException(
          "ChunkGenerator: " + cg.getClass().getName() + " is already a BukkitPlotGenerator!");
    }
    this.full = false;
