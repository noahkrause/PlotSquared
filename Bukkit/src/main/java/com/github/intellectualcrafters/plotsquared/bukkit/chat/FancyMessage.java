...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>,
   ...
   * when the client hovers over the text. <p>Tooltips do not inherit display characteristics, such
   * as color and styles, from the message component on which they are applied.</p>
   *
   ...
   * statistic when the client hovers over the text. <p>Tooltips do not inherit display
   ...
   * parameter with a material when the client hovers over the text. <p>Tooltips do not inherit
   * display characteristics, such as color and styles, from the message component on which they are
   * applied.</p>
   *
   * @param which The statistic to display.
  ...
  /**
   * Set the behavior of the current editing component to display information about a statistic
   * parameter with an entity type when the client hovers over the text. <p>Tooltips do not inherit
   * display characteristics, such as color and styles, from the message component on which they are
   * applied.</p>
   *
   * @param which The statistic to display.
   ...
   * client hovers over the text. <p>Tooltips do not inherit display characteristics, such as color
   * and styles, from the message component on which they are applied.</p>
   *
  ...
  private Object createChatPacket(String json)
    ...
    Object serializedChatComponent = fromJsonMethod
        .invoke(nmsChatSerializerGsonInstance, json, Reflection.getNMSClass("IChatBaseComponent"));
