...
import static com.github.intellectualcrafters.plotsquared.plot.util.ReflectionUtils.callConstructor;
import static com.github.intellectualcrafters.plotsquared.plot.util.ReflectionUtils.callMethod;
import static com.github.intellectualcrafters.plotsquared.plot.util.ReflectionUtils.getCbClass;
import static com.github.intellectualcrafters.plotsquared.plot.util.ReflectionUtils.getNmsClass;
import static com.github.intellectualcrafters.plotsquared.plot.util.ReflectionUtils.getUtilClass;
import static com.github.intellectualcrafters.plotsquared.plot.util.ReflectionUtils.makeConstructor;
import static com.github.intellectualcrafters.plotsquared.plot.util.ReflectionUtils.makeMethod;
...
public class OfflinePlayerUtil {
  ...
  private static Player loadPlayer(UUID id, String name) {
    ...
    Constructor entityPlayerConstructor = makeConstructor(entityPlayerClass,
        getNmsClass("MinecraftServer"), getNmsClass("WorldServer"),
        getUtilClass("com.mojang.authlib.GameProfile"),
        getNmsClass("PlayerInteractManager"));
    Object entityPlayer = callConstructor(entityPlayerConstructor, server, worldServer, profile,
        interactManager);
  ...
  private static Object newGameProfile(UUID id, String name) {
    ...
    Constructor gameProfileConstructor = makeConstructor(gameProfileClass, UUID.class,
        String.class);
