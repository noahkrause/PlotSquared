...
import com.github.intellectualcrafters.plotsquared.bukkit.object.schematic.StateWrapper;
...
public class BukkitSchematicHandler extends SchematicHandler {
  ...
  @Override
  public void getCompoundTag(final String world, final Set<RegionWrapper> regions,
              ...
              TaskManager.runTaskAsync(new Runnable() {
                ...
                public void run() {
                  ...
                  schematic.put("Entities",
                      new ListTag("Entities", CompoundTag.class, new ArrayList<Tag>()));
                  schematic.put("TileEntities",
                      new ListTag("TileEntities", CompoundTag.class, tileEntities));
