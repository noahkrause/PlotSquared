...
public abstract class TextualComponent implements Cloneable {
   ...
   *
   * <p>This is the default type of textual component when a single string literal is given to a
   * method.
   *
   ...
   *
   * <p><b>This method is currently guaranteed to throw an {@code UnsupportedOperationException} as
  ...
  /**
   * Internal class used to represent all types of text components. Exception validating done is on
   * keys and values.
   */
  private static final class ArbitraryTextTypeComponent extends TextualComponent implements
   ...
   */
  private static final class ComplexTextTypeComponent extends TextualComponent implements
      ConfigurationSerializable {
