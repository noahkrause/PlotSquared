...
public class BukkitLocalQueue<T> extends BasicLocalBlockQueue<T> {
  ...
  /**
   * Exploiting a bug in the vanilla lighting algorithm for faster block placement - Could have been
   * achieved without reflection by force unloading specific chunks - Much faster just setting the
   * variable manually though
   */
