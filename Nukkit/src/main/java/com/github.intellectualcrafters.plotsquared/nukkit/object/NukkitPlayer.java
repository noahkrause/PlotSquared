...
public class NukkitPlayer extends PlotPlayer {
  ...
  /**
   * <p>Please do not use this method. Instead use NukkitUtil.getPlayer(Player), as it caches player
   * objects.</p>
   */
  ...
  public void teleport(Location to) {
    ...
    cn.nukkit.level.Location loc = new cn.nukkit.level.Location(to.getX() + 0.5, to.getY(),
        to.getZ() + 0.5, to.getYaw(), to.getPitch(), NukkitUtil.getWorld(to.getWorld()));
